...
| marvin | CPIT | 820726048 (LP 863916131) | `832672327.633` | TopoSort + delay, ordering self-contained desde la relajación Lagrangiana propia (MR-211/MR-213) | -1.456% (supera incumbent 2012 y al candidato con ordering LP staged) | candidato-factible-auditado-self-contained |
| marvin | PCPSP | 885968070 (LP-PCPSP 911704665) | `829532040.176` | TopoSort multi-destino + delay de estéril (MR-212) | +6.370% (LP gap 9.01%; variante self-contained: `828243332.371`, +6.515%) | candidato-factible-auditado |
| marvin | LP-CPIT (bound propio) | 863916131 | `1012282427.850` | Relajación Lagrangiana core, 100% precedencias (MR-213, 60 iter) | +17.17% (gap dual restante, no atajo de cobertura) | valid-upper-bound |
| marvin | LP-PCPSP (bound propio) | 911704665 | `1050315036.575` | Relajación Lagrangiana core, 100% precedencias (MR-213, 60 iter); el sidecar parcial previo (`minilp` 10% filas, 899374039.13) queda solo como diagnóstico benchmark-side | +15.20% (gap dual restante) | valid-upper-bound |
...
| mclaughlin-limit | LP-CPIT (bound propio) | 1078979501 | `1102209588.990` | Relajación Lagrangiana core, 100% precedencias (MR-213, 20 iter) | +2.15% (gap dual restante) | valid-upper-bound |
| mclaughlin-limit | LP-PCPSP (bound propio) | 1324829727 (artefacto LPpcpsp no staged) | `1381821817.532` | Relajación Lagrangiana core, 100% precedencias (MR-213/MR-214, 20 iter); primer bound PCPSP propio para esta instancia | +4.30% (gap dual restante) | valid-upper-bound |
